...
**HEAD analysis date:** 2026-07-16 (corpus July 2026)  
**Parent note:** `papers/amplification-no-free-lunch.md` §6.3  
...
Global horizon count \(N_{\mathrm{BH}}\sim 10^{122}\) is smaller-side by \(\sim 10^{112}\)–\(10^{114}\) for these \(N_{\mathrm{eff}}\).
