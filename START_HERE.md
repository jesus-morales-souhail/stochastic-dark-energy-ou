...
Under the OU/QNM residual kernel I use on public DESI DR2 BAO, a stochastic residual is not required. Working ceiling: $\sigma_X < 2.5\times 10^{-2}$ (95% CL). Soft amplification of a pure Sorkin seed $\sim 10^{-61}$ to telescope-band residuals needs $\sim 10^{56}$–$10^{59}$ and is not free.
