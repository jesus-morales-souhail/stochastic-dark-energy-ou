...
| **N10** | Residual ceiling \(\sigma_X\) is not the baryon density \(\omega_b\); VLBI / photon sphere are not residual claims. See [`papers/scope-and-mixups.md`](../papers/scope-and-mixups.md) |
