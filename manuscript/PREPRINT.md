...
\[
\mathrm{d}X=-\theta X\,\mathrm{d}x+\sigma\,\mathrm{d}W_x,\quad
...
\[
C^{\mathrm{OU}}_{ij}=\sigma_X^2 e^{-\theta\Delta x_{ij}},\quad
C^{\mathrm{QNM}}_{ij}=\sigma_X^2 e^{-\theta\Delta x_{ij}}\cos(\omega_R\Delta x_{ij}).
\]
...
\[
\lvert\gamma-1\rvert=\left\lvert\frac{\Phi-\Psi}{\Psi}\right\rvert
=2\varepsilon\sigma_X\frac{\rho_X}{\rho_m\lvert\delta_m\rvert},
\]
