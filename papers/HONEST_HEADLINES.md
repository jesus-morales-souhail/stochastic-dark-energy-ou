...
1. Residual bound $\sigma_X < 2.5\times 10^{-2}$ (95% CL, OU kernel, public DESI DR2 BAO).
...
**Measurement**
> Dark energy shows no fluctuations above $2.5\times 10^{-2}$ under a DESI DR2 BAO residual analysis (OU kernel).
...
> I do not compute a new vacuum energy density. I bound late-time DE residuals with DESI DR2 ($\sigma_X<2.5\times 10^{-2}$ (95% CL)), exclude coherent tachyonic growth, and show that a pure Sorkin seed sits $\sim 10^{56}$–$10^{59}$ below residual scales — a gap soft amplifiers do not close.
