...
Combined with astrophysical bounds from quasar absorption spectroscopy (\(|\Delta\alpha/\alpha| \lesssim 10^{-5}\) at \(z \sim 7\), Wilczyńska et al. 2020 [7]), this limit disfavors models with \(|\beta| \sim 1\) and \(|V/V'| \sim \mathcal{O}(1)\) unless additional screening mechanisms suppress the observable variation.
